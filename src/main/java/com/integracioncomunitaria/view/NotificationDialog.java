...
public class NotificationDialog extends JDialog {
    ...
    public NotificationDialog(Frame parent, int providerId) {
    ...
    private void loadNotifications() {
        ...
        List<Map<String, Object>> notifications = notificationController.getNotifications(providerId, "customer");
    ...
    private void replyToNotification(Map<String, Object> notification) {
        ...
        if (replyMessage != null && !replyMessage.trim().isEmpty()) {
            notificationController.sendReply(providerId, (int) notification.get("id_notification"), replyMessage);
